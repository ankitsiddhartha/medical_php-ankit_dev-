      ...
      <div class="row">
        <div class="col s12 m6 l8 tagline">
			  ...
			  <div class="col s7" style="padding-left:0px">
				...
				<p>MAD is a platform for doctors to interact and ask questions, and get replies from qualified and experienced professionals.</p>
			  </div>
        </div>          
	  </div>
	</div>
