	    	...
	    	<div class="card-content question">
		      ...
		      <p class="grey-text text-darken-1"><i class="material-icons">access_time</i> Started on Date: <?php echo $date;?></p>
	    		...
	    		<div class="card-action">
	    			<a href="http://avekare.net16.net/email.php?first_name=<?php echo $doctor_first ?>&last_name=<?php echo $doctor_last ?>&email=<?php $username ?>&reciever_email=ankitsiddhartha5@gmail.com" target="_blank" style="color:#673ab7" class="modal-trigger">Colaborate <i class="material-icons">note_add</i></a>
